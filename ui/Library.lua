...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local HueTextSize = Library:GetTextBounds('Hex color', Enum.Font.RobotoMono, 16) + 3
        local RgbTextSize = Library:GetTextBounds('255, 255, 255', Enum.Font.RobotoMono, 16) + 3
...
function Library:SetWatermark(Text)
    local Size = Library:GetTextBounds(Text, Enum.Font.RobotoMono, 14);
...
function Library:Notify(Text, Time)
    local MaxSize = Library:GetTextBounds(Text, Enum.Font.RobotoMono, 14);
...
function Library:CreateWindow(WindowTitle)
    ...
    function Window:AddTab(Name)
        ...
        local TabButtonWidth = Library:GetTextBounds(Name, Enum.Font.RobotoMono, 16);
